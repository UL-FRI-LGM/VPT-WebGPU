...
const className = ClassName('cnvs');
// Custom view class should implement `View` interface
class PluginView {
    //transferfunction: HTMLDivElement;
    //private textElem_: HTMLElement;
    constructor(doc, config) {
        this.dotElems_ = [];
        this.scaleSpeed = 0.003;
        ...
        //this.canvasDiv = this.document.createElement('div', {is : 'ui-transfer-function'});
        //this.element.appendChild(this.canvasDiv);
        // Create child elements
        //this._addBumpElement.addEventListener("click", this.addBump_);
        //this.textElem_ = document.createElement('div');
        //this.textElem_.classList.add(className('text'));
        //this.element.appendChild(this.textElem_); */
        this.canvasDiv = this.document.createElement("div");
        this.canvasDiv.classList.add("tweakpaneCanvas");
        ...
        /*
                ...
                this._program = this._program.TransferFunction;
...
class PluginController {
    /* private btnAddNew: ButtonController;
    private btnRemoveAll: ButtonController;
    private btnRemoveSelected: ButtonController; */
    //public readonly bumps: Bump[] = [];
    constructor(doc, config) {
        ...
        // Create buttons
        //this.view.element.style.gridTemplateColumns = `repeat(${2}, 1fr)`;
        /* 		this.btnAddNew = new ButtonController(doc, {
                ...
                this.btnRemoveSelected= new ButtonController(doc, {
                    props: ValueMap.fromObject<ButtonPropsObject>({
                ...
                this.btnRemoveAll = new ButtonController(doc, {
                    props: ValueMap.fromObject<ButtonPropsObject>({
                ...
                this.viewProps.handleDispose(() => {
                    ...
                    this.btnAddNew.viewProps.set('disposed', true);
                    this.btnRemoveAll.viewProps.set('disposed', true);
                    this.btnRemoveSelected.viewProps.set('disposed', true);
                });
                
                this.view.element.appendChild(this.btnAddNew.view.element);
                this.view.element.appendChild(this.btnRemoveSelected.view.element);
                this.view.element.appendChild(this.btnRemoveAll.view.element); */
...
//
const CanvasPanePlugin = createPlugin({
    id: 'canvas-pane',
    ...
    accept(exValue, params) {
        ...
        if (params.view !== 'canvas-pane') {
            return null;
        }
        // Parse parameters object
        const result = parseRecord(params, (p) => ({
            view: p.required.constant('canvas-pane'),
            bumps: p.optional.string,
        }));
        if (!result) {
            return null;
        }
